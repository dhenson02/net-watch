    ...
    const series =
      view === 'treemap'
        ? {
            ...
            label: { show: true, formatter: label, fontSize: fontPx(13), lineHeight: 15, overflow: 'truncate' },
        ...
        : {
            ...
            label: { formatter: (p: NodeParams) => p.name ?? '', minAngle: 8, overflow: 'truncate', color: '#fff', fontSize: fontPx(12) },
            levels: [
              {},
              { r0: '14%', r: '44%', itemStyle: { borderWidth: 2 }, label: { rotate: 'tangential', fontWeight: 600, fontSize: fontPx(13) } },
              { r0: '44%', r: '74%', label: { rotate: 'radial', width: 80 } },
              { r0: '74%', r: '95%', label: { rotate: 'radial', width: 50, fontSize: fontPx(12) } },
            ],
          };
    return {
      animation: false,
